...
import { BarChart3, Users, Trophy, Target, FileText, CheckSquare, Calendar, Database, Crown, UserPlus } from 'lucide-react';
...
const AdminTabs: React.FC<AdminTabsProps> = ({ activeTab, onTabChange }) => {
  ...
  const tabs = [
    ...
    { key: 'bulk-cadets', name: 'Массовое добавление', icon: UserPlus, permission: 'manage_cadets' },
